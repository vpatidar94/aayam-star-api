...
const { getResultDashboard, generateRank, getResultByTest, getAllScorePoints, sendWpMessage, getAllResultsDetails, getTestResultByUser } = require("../controller.js/result-controller");
